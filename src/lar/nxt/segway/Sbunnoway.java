 ...
 *
 */
public class Sbunnoway extends Thread { // TODO: Thread should be a private inner class.
	 ...
	 */
	private static final double TIME_FALL_LIMIT = 1500; // originally 1000
	...
	public Sbunnoway(EncoderMotor left, EncoderMotor right, Gyroscope gyro, double wheelDiameter) {
	...
	public void run() {
		...
		while(true) {
			...
			power = (int)((KGYROSPEED * gyroSpeed +               // Deg/Sec from Gyro sensor
					KGYROANGLE * (gyroAngle-angleRef)) / ratioWheel + // Deg from integral of gyro
